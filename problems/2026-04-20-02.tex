...
已知向量组(Ⅰ)\(\alpha_1, \alpha_2, \alpha_3\) 和(Ⅱ)\(\beta_1, \beta_2, \beta_3, \beta_4\) 都是四维非零列向量。若 \(\alpha_1, \alpha_2, \alpha_3\) 线性无关且和每个 \(\beta_j\ (j=1,2,3,4)\) 都正交，则秩 \(r(\mathrm{I}) + r(\mathrm{II}) =\)
...
因此，由这些解构成的向量组(Ⅱ)的秩满足 \(r(\mathrm{II}) \le 1\)。
